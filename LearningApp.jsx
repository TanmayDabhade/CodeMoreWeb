...
const LearningApp = () => {
  ...
  useEffect(() => {
    getFile('/start-learning-python');
  }, []);

  return (
    <Router>
      <div className='w-full'>
        <NavBar getFile={getFile} />
        <Switch>
          <Route path="/start-learning-python">
            <Getdata file={file} title={title} />
          </Route>
          <Route path="/start-learning-cpp">
            <Getdata file={file} title={title} />
          </Route>
          <Route path="/start-learning-swift">
            <Getdata file={file} title={title} />
          </Route>
          <Route path="/">
            <Getdata file={file} title={title} />
